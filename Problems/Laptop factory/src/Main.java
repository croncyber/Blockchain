class TestDrive {
    public static void main(String[] args) throws InterruptedException {
        ...
        LaptopFactory dellFactory = new DellXPSFactory();/* write your code here */
        LaptopFactory macbookFactory = new MacBookFactory();/* write your code here */
        ...
        laptop = dellFactory.createComputer();/* write your code here */
        ...
        laptop = macbookFactory.createComputer();/* write your code here */
        System.out.println(laptop.getDescription());
        System.out.println("There it is!");
    }
}
