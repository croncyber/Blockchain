...
class Bathroom {
    ...
    public void fill() {
        ...
        System.out.println(String.format("Temperature: %s", favoriteTemperature));
        System.out.println(String.format("Water level: %s", favoriteLevel));
    }
...
class Lights {
    ...
    public void on() {
        System.out.println(description + " on");
        System.out.println(String.format("Color temperature is: %s", favoriteColorTemperature));
    }
