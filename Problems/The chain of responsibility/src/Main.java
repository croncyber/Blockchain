...
class ChainOfResponsibilityDemo {
    ...
    interface RequestHandler {
        ...
        Request handle(Request notCompletedRequest);

        default RequestHandler setSuccessor(RequestHandler requestHandler) {
            return r -> handle(requestHandler.handle(r));
        }
     ...
     */
    final static RequestHandler commonRequestHandler = (r) -> wrapInRequestTag.setSuccessor(createDigest).setSuccessor(wrapInTransactionTag).handle(r);
